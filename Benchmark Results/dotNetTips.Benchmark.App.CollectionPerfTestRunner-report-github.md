...
```
|                          Method |     Toolchain | Count |         Mean |       Error |       StdDev |       Median | Rank |   Gen 0 |   Gen 1 |   Gen 2 | Allocated |
|-------------------------------- |-------------- |------ |-------------:|------------:|-------------:|-------------:|-----:|--------:|--------:|--------:|----------:|
|                  **CREATION:for()** | **.NET Core 2.2** |   **100** |   **1,132.8 ns** |     **4.84 ns** |      **4.53 ns** |   **1,130.4 ns** |    **6** |  **0.0973** |       **-** |       **-** |    **2200 B** |
|                  CREATION:for() | .NET Core 3.0 |   100 |     963.9 ns |     3.30 ns |      2.92 ns |     962.5 ns |    4 |  0.2289 |       - |       - |    2192 B |
|                  CREATION:for() |        net472 |   100 |   1,028.2 ns |     2.77 ns |      2.31 ns |   1,028.1 ns |    5 |  1.0509 |       - |       - |    2207 B |
|                  CREATION:for() |         net48 |   100 |   1,019.6 ns |     1.15 ns |      1.02 ns |   1,019.6 ns |    5 |  1.0509 |       - |       - |    2207 B |
|                  CREATION:for() | .NET Core 2.2 |   500 |   4,112.9 ns |    19.66 ns |     18.39 ns |   4,117.3 ns |   24 |  0.4120 |       - |       - |    8392 B |
|                  CREATION:for() | .NET Core 3.0 |   500 |   3,810.6 ns |    10.84 ns |     10.14 ns |   3,809.5 ns |   21 |  0.8774 |       - |       - |    8384 B |
|                  CREATION:for() |        net472 |   500 |   4,531.7 ns |     7.44 ns |      6.96 ns |   4,530.4 ns |   26 |  4.0054 |       - |       - |    8418 B |
|                  CREATION:for() |         net48 |   500 |   4,419.2 ns |     7.10 ns |      6.64 ns |   4,419.1 ns |   25 |  4.0054 |       - |       - |    8418 B |
|                  CREATION:for() | .NET Core 2.2 |  1000 |   7,815.8 ns |    11.44 ns |     10.14 ns |   7,816.6 ns |   35 |  0.6409 |       - |       - |   16608 B |
|                  CREATION:for() | .NET Core 3.0 |  1000 |   7,916.2 ns |    20.76 ns |     19.42 ns |   7,909.8 ns |   35 |  1.8768 |  0.0153 |       - |   16600 B |
|                  CREATION:for() |        net472 |  1000 |   8,560.1 ns |    18.47 ns |     17.28 ns |   8,555.9 ns |   39 |  7.9346 |       - |       - |   16661 B |
|                  CREATION:for() |         net48 |  1000 |   8,634.4 ns |    97.29 ns |     91.01 ns |   8,592.0 ns |   39 |  7.9346 |       - |       - |   16661 B |
|                  CREATION:for() | .NET Core 2.2 |  2500 |  21,614.5 ns |   384.88 ns |    360.02 ns |  21,914.0 ns |   52 |  2.4719 |  0.1221 |       - |   65808 B |
|                  CREATION:for() | .NET Core 3.0 |  2500 |  22,814.7 ns |   174.77 ns |    163.48 ns |  22,878.9 ns |   53 |  6.5002 |  0.2747 |       - |   65800 B |
|                  CREATION:for() |        net472 |  2500 |  24,170.4 ns |   308.90 ns |    288.94 ns |  24,097.8 ns |   54 | 31.2195 |       - |       - |   65936 B |
|                  CREATION:for() |         net48 |  2500 |  24,569.3 ns |    55.79 ns |     52.19 ns |  24,571.9 ns |   54 | 31.2195 |       - |       - |   65936 B |
|                  CREATION:for() | .NET Core 2.2 |  5000 |  43,264.5 ns |   740.70 ns |    692.85 ns |  42,839.5 ns |   64 |  6.3477 |  0.8545 |       - |  131368 B |
|                  CREATION:for() | .NET Core 3.0 |  5000 |  46,361.8 ns |   341.92 ns |    319.83 ns |  46,210.9 ns |   65 | 13.1226 |  1.5869 |       - |  131360 B |
|                  CREATION:for() |        net472 |  5000 |  50,440.5 ns |   141.00 ns |    124.99 ns |  50,443.6 ns |   66 | 62.4390 |       - |       - |  131520 B |
|                  CREATION:for() |         net48 |  5000 |  50,296.4 ns |    81.73 ns |     72.45 ns |  50,301.8 ns |   66 | 62.3779 |       - |       - |  131520 B |
|  **&#39;CREATION:for() with Capacity&#39;** | **.NET Core 2.2** |   **100** |     **748.4 ns** |     **8.53 ns** |      **7.98 ns** |     **751.1 ns** |    **2** |  **0.0372** |       **-** |       **-** |     **864 B** |
|  &#39;CREATION:for() with Capacity&#39; | .NET Core 3.0 |   100 |     676.6 ns |    10.27 ns |      9.10 ns |     676.3 ns |    1 |  0.0896 |       - |       - |     856 B |
|  &#39;CREATION:for() with Capacity&#39; |        net472 |   100 |     802.1 ns |     1.41 ns |      1.25 ns |     802.1 ns |    3 |  0.4129 |       - |       - |     867 B |
|  &#39;CREATION:for() with Capacity&#39; |         net48 |   100 |     798.7 ns |     1.12 ns |      0.94 ns |     798.5 ns |    3 |  0.4129 |       - |       - |     867 B |
|  &#39;CREATION:for() with Capacity&#39; | .NET Core 2.2 |   500 |   3,419.9 ns |     4.39 ns |      4.10 ns |   3,419.3 ns |   20 |  0.1831 |       - |       - |    4064 B |
|  &#39;CREATION:for() with Capacity&#39; | .NET Core 3.0 |   500 |   3,200.9 ns |     6.10 ns |      5.41 ns |   3,201.1 ns |   19 |  0.4234 |       - |       - |    4048 B |
|  &#39;CREATION:for() with Capacity&#39; |        net472 |   500 |   4,050.7 ns |     7.08 ns |      6.62 ns |   4,050.0 ns |   23 |  1.9379 |       - |       - |    4080 B |
|  &#39;CREATION:for() with Capacity&#39; |         net48 |   500 |   3,956.1 ns |     8.17 ns |      7.24 ns |   3,955.3 ns |   22 |  1.9379 |       - |       - |    4080 B |
|  &#39;CREATION:for() with Capacity&#39; | .NET Core 2.2 |  1000 |   6,885.1 ns |    87.92 ns |     82.24 ns |   6,910.7 ns |   33 |  0.3357 |       - |       - |    8064 B |
...
|            for():ImmutableArray |        net472 |   100 |   1,514.7 ns |    19.98 ns |     18.69 ns |   1,526.6 ns |    7 |  1.1578 |       - |       - |    2431 B |
...
|             for():ImmutableList | .NET Core 3.0 |  5000 | 371,132.8 ns |   410.30 ns |    320.34 ns | 371,108.9 ns |   92 |       - |       - |       - |         - |
...
|        for():ReadOnlyCollection | .NET Core 2.2 |  2500 | 115,699.0 ns |   227.39 ns |    212.70 ns | 115,691.9 ns |   79 |       - |       - |       - |         - |
